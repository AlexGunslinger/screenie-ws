			...
			<p>
				Hacemos que el Departamento de Recursos Humanos sea el héroe en cualquier organización.
					...
					<div style="width:280px;float:right;">
						...
						<!-- Form -->
						<form  style="background-color:#1acad4; margin:10px; margin-right:0px !important; padding:10px; border-radius: 10px; color:white; float:right;" method="POST" action="landing_thanks.php" enctype="multipart/form-data" >
