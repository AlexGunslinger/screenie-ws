<?php
$META_TITLE = 'Disponibilidad - Herramienta de reclutamiento móvil y fácil de usar';
$META_DESCRIPTION = "Herramienta de reclutamiento móvil y fácil de usar.";
...
<?php
	...
	$feature = array(
		"title" => "Disponible a cualquier hora, en cualquier lugar",
		"tagline" => "Hace más rápido y fácil el reclutamiento y la contratación de personal",
		"bullets" => array(
			"Los candidatos pueden realizar la entrevista desde una computadora, cualquier dispositivo móvil o teléfono fijo.",
			"Los reclutadores pueden revisar y calificar a los candidatos desde una computadora o cualquier dispositivo móvil.",
			"Compatible con cualquier navegador (IE, Firefox, Chrome, Safari)."
		),
