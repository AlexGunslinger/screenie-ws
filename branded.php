<?php
$META_TITLE = 'Personalizable con marca propia - Nuestro software de reclutamiento se integra a tu página empresarial';
$META_DESCRIPTION = "Nuestro software de reclutamiento se integra a tu página empresarial";
include_once 'includes/header.php';
$PAGE_TITLE = "Personalizable con marca propia";
?>
<?php
	// Define "Feature" Attributes here. 
	$feature = array(
		"title" => "Portales de entrevistas personalizables con su marca",
		"tagline" => "Trabaje integrando su marca",
		"bullets" => array(
			"Reciba un portal profesional personalizable con su propio subdominio, imagen y logo.",
			"Promueva su marca mientras optimiza su proceso de reclutamiento y selección de personal.",
			"Comunique la visión, misión, valores y cultura de su empresa a través de un video dinámico al inicio de las entrevistas. "
			),
		"image" => "features-icon-computer.png"
		)
?>
<!-- Section -->
